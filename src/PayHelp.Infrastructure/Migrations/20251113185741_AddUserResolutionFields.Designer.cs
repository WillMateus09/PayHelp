...
namespace PayHelp.Infrastructure.Migrations
{
    ...
    [Migration("20251113185741_AddUserResolutionFields")]
    partial class AddUserResolutionFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayHelp.Domain.Entities.ReportEntry", b =>
                {
                    ...
                    b.Property<bool>("ResolvidoPeloUsuario")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PayHelp.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<DateTime?>("DataResolvidoUsuario")
                        .HasColumnType("datetime2");
